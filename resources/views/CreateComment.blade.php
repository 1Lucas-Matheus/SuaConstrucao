            ...
            <div>
                <form action="/storeComment" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-2" name="idUserComentou" value="{{$UserSession->name}}">
                    </div>

                    <div class="form-group">
                        <label>Quem tá recebendo o comentario:</label>
                        <input type="text" class="form-control mb-2" name="idUserComentado" value="{{$UserCommented->name}}">
                    </div>
